...
using CashFlow.Common.Extensions;
...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach(var expense in expenses)
        {
            ...
            SetStyleBaseForExpensInformation(row.Cells[0]);
            row.Cells[0].Format.LeftIndent = 20;            

            row.Cells[1].AddParagraph(expense.Date.ToString("t"));
            SetStyleBaseForExpensInformation(row.Cells[1]);            

            row.Cells[2].AddParagraph(expense.PaymentType.PaymentTypeToString());
            SetStyleBaseForExpensInformation(row.Cells[2]);
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[0].AddParagraph("Photo");
    ...
    private void AddHeaderForAmont(Cell cell)
    {
    ...
    private void SetStyleBaseForExpensInformation(Cell cell)
    {
